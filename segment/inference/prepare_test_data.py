...
from segment.utils.file_utils import read_yaml_file, write_json_file, logger
...
def prepare_test_data(data_path:str, config_path:str, vol_path:str, out_path:str):
    ...
    imaging_path = [os.path.join(data_path, f"case_00{num}/imaging.nii.gz") for num in range(210, 300)]
    ...
    [np.save(vol_path, vol) for vol_path, vol in zip(preprocessed_vol_path, preprocessed_vol)]
